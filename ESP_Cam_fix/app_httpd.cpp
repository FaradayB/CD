...
void startCameraServer()
{
    ...
    // 1) Stream-on-root handler
    static httpd_uri_t stream_uri_root = {
        .uri       = "/",
        .method    = HTTP_GET,
    ...
    // 2) (Optional) still serve it also on /stream
    ...
    // 3) All your other URIs exactly as before:
    ...
    static httpd_uri_t xclk_uri = {
        .uri       = "/xclk",
        .method    = HTTP_GET,
        .handler   = xclk_handler,
        .user_ctx  = NULL
    };
    static httpd_uri_t reg_uri = {
        .uri       = "/reg",
        .method    = HTTP_GET,
        .handler   = reg_handler,
        .user_ctx  = NULL
    };
    static httpd_uri_t greg_uri = {
        .uri       = "/greg",
        .method    = HTTP_GET,
        .handler   = greg_handler,
        .user_ctx  = NULL
    };
    static httpd_uri_t pll_uri = {
        .uri       = "/pll",
        .method    = HTTP_GET,
        .handler   = pll_handler,
        .user_ctx  = NULL
    };
    static httpd_uri_t win_uri = {
        .uri       = "/resolution",
        .method    = HTTP_GET,
        .handler   = win_handler,
        .user_ctx  = NULL
    ...
    if (httpd_start(&camera_httpd, &config) == ESP_OK) {
        // **Register root stream first**, so “/” always matches
        httpd_register_uri_handler(camera_httpd, &stream_uri_root);
        // then all the others
    ...
    // (you can drop the second “stream_httpd” server entirely if you like;
    //  this single server now handles / and /stream both.)
}
